...
*(The half-title, repeating page 1 with one word changed. Latin.)*

THE HYPNEROTOMACHIA OF POLIPHILO, WHEREIN HE SHOWS THAT ALL HUMAN THINGS ARE NOTHING BUT A
DREAM, AND ALONG THE WAY RECOUNTS VERY MANY THINGS THOROUGHLY WORTHY OF KNOWING.
...
- **One word is different from page 1, and it is the verb.** The title page has *docet* — "he
  ...
  **shows**". Whether that is a compositor's variation or a considered second thought, the pair
  is a fair description of how the book actually works: it teaches in the text and shows in the
