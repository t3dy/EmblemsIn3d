<!-- tokens: ~7,213 · read for: the task table; read this first, then two or three files -->
...
*Generated by `scripts/doc_costs.py`. **67 files in the root, ~232,311 tokens all told** — which is why this file exists and why you should open two or three of them and not twenty. The estimate is chars/4; it is for deciding whether you can afford a file, and being wrong by ten per cent never changes that. Re-run the script after any substantial documentation change.*

| tokens | file | read for |
|---:|---|---|
| ~29,386 | `COVERAGE.md` | what the book has that the world does not (generated) · generated |
| ~18,645 | `TICKETS.md` | the engineering queue (generated) · generated |
| ~11,293 | `NEXTSTEPS.md` | Ted's standing asks, in his words |
| ~7,237 | `15scholars.md` | what each scholar will and will not support |
| ~7,213 | `ROUTER.md` | the task table; read this first, then two or three files |
...
| ~4,754 | `DECISIONS.md` | the index of every directional call |
...
| ~2,787 | `PLAN.md` |  |
| ~2,669 | `HANDOVER.md` | where this project stands and what to do next |
