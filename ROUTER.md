<!-- tokens: ~7,184 · read for: the task table; read this first, then two or three files -->
...
*Generated by `scripts/doc_costs.py`. **67 files in the root, ~223,420 tokens all told** — which is why this file exists and why you should open two or three of them and not twenty. The estimate is chars/4; it is for deciding whether you can afford a file, and being wrong by ten per cent never changes that. Re-run the script after any substantial documentation change.*

| tokens | file | read for |
|---:|---|---|
| ~25,312 | `COVERAGE.md` | what the book has that the world does not (generated) · generated |
| ~16,553 | `TICKETS.md` | the engineering queue (generated) · generated |
| ~10,510 | `NEXTSTEPS.md` | Ted's standing asks, in his words |
| ~7,237 | `15scholars.md` | what each scholar will and will not support |
| ~7,184 | `ROUTER.md` | the task table; read this first, then two or three files |
...
| ~2,132 | `HANDOVER.md` | where this project stands and what to do next |
| ~2,066 | `CRUST.md` |  |
| ~2,057 | `STATUS.md` |  |
