...
*Generated by `scripts/doc_costs.py`. **67 files in the root, ~228,778 tokens all told** — which is why this file exists and why you should open two or three of them and not twenty. The estimate is chars/4; it is for deciding whether you can afford a file, and being wrong by ten per cent never changes that. Re-run the script after any substantial documentation change.*

| tokens | file | read for |
|---:|---|---|
| ~29,203 | `COVERAGE.md` | what the book has that the world does not (generated) · generated |
| ~17,562 | `TICKETS.md` | the engineering queue (generated) · generated |
| ~10,768 | `NEXTSTEPS.md` | Ted's standing asks, in his words |
...
| ~4,666 | `DECISIONS.md` | the index of every directional call |
...
| ~2,303 | `HANDOVER.md` | where this project stands and what to do next |
