<!-- tokens: ~7,194 · read for: the task table; read this first, then two or three files -->
...
| ~10,141 | `NEXTSTEPS.md` | Ted's standing asks, in his words |
| ~7,237 | `15scholars.md` | what each scholar will and will not support |
| ~7,194 | `ROUTER.md` | the task table; read this first, then two or three files |
...
| ~3,304 | `RENDERINGMODELSBLINGUSOUT.md` |  |
| ~3,279 | `WOODCUT.md` |  |
