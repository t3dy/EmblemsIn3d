<!-- tokens: ~7,007 · read for: the task table; read this first, then two or three files -->
...
| ~4,544 | `ENGINEERING.md` | how this project is built, measured and handed over |
| ~4,501 | `GARDENS.md` | the island's rings, terraces, parterres, topiary |
| ~4,485 | `DECISIONS.md` | the index of every directional call |
| ~4,258 | `DIMENSIONS.md` | how big anything is, in metres, with sources |
| ~4,143 | `DIRECTIONS.md` | where things stand in relation to each other; the compass |
| ~4,008 | `COMPLETE_BRIEFING.md` | SUPERSEDED — June 2026 two-world planning |
| ~4,006 | `INDEX.md` |  |
| ~3,996 | `ROLLING.md` | every variable in Roll Up and which one to turn |
