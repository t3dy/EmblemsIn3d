<!-- tokens: ~7,013 · read for: the task table; read this first, then two or three files -->
...
| ~7,662 | `TICKETS.md` | the engineering queue (generated) · generated |
| ~7,237 | `15scholars.md` | what each scholar will and will not support |
| ~7,013 | `ROUTER.md` | the task table; read this first, then two or three files |
...
| ~4,448 | `ROLLING.md` | every variable in Roll Up and which one to turn |
