<!-- tokens: ~7,056 · read for: the task table; read this first, then two or three files -->
...
| ~10,092 | `TICKETS.md` | the engineering queue (generated) · generated |
| ~7,237 | `15scholars.md` | what each scholar will and will not support |
| ~7,056 | `ROUTER.md` | the task table; read this first, then two or three files |
