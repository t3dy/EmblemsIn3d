...
`Cast.props.tree()` in the woodcut register. Stations checked against their chapters so far: the obelisk of the Trinity, the second bridge, the palace, the court, the three doors, and the Polyandrion (ciborium, crypt, Hell mosaic, Artemisia's sepulchre, six epitaphs — pp. 246-271, #94-#112); the Great Portal checked and left; **the bath's frieze remains.** **Segre's knot gardens and parterres are built**
