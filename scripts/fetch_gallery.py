...
ENTRIES = [
    ...
    dict(id="hp_frontispiece", category="The 1499 woodcuts", title="A woodcut initial",
         artist="Hypnerotomachia Poliphili (anon. woodcut)", date="Venice, 1499",
         caption="One of the book's ornamented capitals; the great chapter-initials together spell the author's acrostic — POLIAM FRATER FRANCISCVS COLVMNA PERAMAVIT.",
         files=["Hypnerotomachia Poliphili pag011.jpg", "Hypnerotomachia Poliphili pag013.jpg",
                "Hypnerotomachia Poliphili pag009.jpg"]),
    dict(id="hp_elephant", category="The 1499 woodcuts", title="A garden fountain",
         artist="Hypnerotomachia Poliphili", date="Venice, 1499",
         caption="A nymph beside a fountain in the antique garden — one of the dream's recurring scenes.",
         files=["Hypnerotomachia Poliphili pag025.jpg", "Hypnerotomachia Poliphili pag021.jpg",
                "Hypnerotomachia Poliphili pag024.jpg"]),
    dict(id="hp_portal", category="The 1499 woodcuts", title="The elephant and obelisk",
         artist="Hypnerotomachia Poliphili", date="Venice, 1499",
         caption="The stone elephant with a spiral stair through its belly, bearing an obelisk — the woodcut Bernini later built in stone in the Piazza della Minerva.",
