...
head.append('project: EVERY PAGE of the 1499 edition, from the title page to the Aldine')
head.append('colophon. Robert Dallington\'s 1592 English - the only prior public-domain')
head.append('translation - covers pages 1-192 and breaks off inside page 193, at the word')
head.append('Mustulento. Everything after that point has existed in English only under')
head.append('copyright, and is rendered here for the first time; the first half is given')
head.append('afresh beside his, so the whole book can be read in one voice.')
head.append('')
