...
export function createMeadowField({
  count = 20000,
  // There is no sensible default at 13.7 km. STAGE 2 (2026-09-20) makes every
  // caller in nature.js._buildMeadow pass bounds derived from PLAN_SITES, and
  // this default is now only a small patch about the origin so that a caller
  // who forgets shows up as a visible mistake rather than as a field silently
  // scattered over the wrong five kilometres.
  bounds = { x0: -60, x1: 60, z0: -60, z1: 60 },
  seed = 7331,
  clearance = null,
  accept = null,
  blade = {},
