...
//
//   `text`            our own prose summary, written to follow the book
//                     closely. This carries the plot: nobody is going to read
//                     four hundred pages standing in a garden.
//   `quote` + `voice` the quoted matter, never a paraphrase. `voice` decides
//                     the tag and the rule colour the panel draws:
//
//     '1592'  Robert Dallington's Elizabethan English — "Hypnerotomachia: The
//             Strife of Loue in a Dreame," London 1592 — in original spelling.
//             It breaks off partway through chapter XVII, so the later stops
//             cannot draw on it.
//     '1499'  the Aldine's own Latin and Greek: mottoes, door inscriptions,
//             hieroglyphic glosses, the acrostic, Polia's epitaph.
//     'ours'  our new translation of the post-1592 remainder, made from the
//             Italian in translation/source/. Carries `page` (the facsimile
//             page, which links to the parallel text) and `draft: true` while
//             that page still holds an uncertain reading.
//
// All quoted matter is public domain. Joscelyn Godwin's 1999 translation is in
// copyright and is not used here in any form; see docs/HP_SOURCEBOOK.md for the
// rights note and TRANSLATIONDISPLAYCHOICES.md for why the voices are marked.
//
  ...
  },
  {
    ...
    beats: [
      { text: 'At the fountain of Venus, in the innermost ring of the innermost garden, Poliphilo at last takes Polia in his arms — and she dissolves. The Sun comes up like an informer. Dallington’s Elizabethan English gave out long before this page, so what follows is our own rendering of the 1499 Italian.',
        ...
        voice: 'ours', page: 465, draft: true },
